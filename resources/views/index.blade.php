				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-center">
							<h2 class="border-b">{{$section_title}} <!-- e}} <img class="img-mar" src="https://ik.imagekit.io/soufeel/en/skin/frontend/smartwave/default/custom/static/home/home-nine/icon-02.p --> </h2> 
						</div>
					</div>
